...
export const TrainingOpportunitiesCarousel = () => {
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-slate-900/80 via-slate-900/70 to-slate-950/90 p-5 shadow-[0_25px_70px_-45px_rgba(0,255,255,0.35)]">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-bold bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">
            Trending Training Opportunities
          </h3>
        </div>
      ...
      <div className="relative">
        <div className="overflow-hidden rounded-xl border border-slate-700/50 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 transition-all duration-300 hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/20">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3 border-y border-slate-700/30 py-4">
              <div className="flex items-center gap-2 text-slate-300">
                <Zap className="w-4 h-4 text-cyan-400" />
                <div>
                  <p className="text-xs text-slate-500">Level</p>
                  <p
                    className={`text-sm font-semibold px-2 py-1 rounded capitalize ${getLevelColor(currentTraining.level)}`}
                  >
          ...
          <div className="flex gap-3 border-t border-slate-700/30 bg-slate-900/50 px-6 py-4">
            <button
              onClick={() => handleEnrollTraining(currentTraining)}
              disabled={isEnrolling === currentTraining._id}
              className="flex-1 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-2 font-semibold text-white transition-all duration-200 transform hover:scale-105 hover:from-cyan-600 hover:to-blue-600 disabled:opacity-60"
            >
            ...
            <button
              ...
              className="flex-1 rounded-lg border border-slate-600/50 bg-slate-700/50 px-4 py-2 font-semibold text-slate-200 transition-all duration-200 hover:border-cyan-500/30 hover:bg-slate-600/50 disabled:opacity-50"
            >
        ...
        {trainings.length > 1 && (
          <>
            <button
              onClick={handlePrev}
              className="absolute -left-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg transition-all duration-200 transform hover:scale-110 hover:from-cyan-600 hover:to-blue-600 hover:shadow-cyan-500/50"
            >
              <ChevronLeft className="w-6 h-6" />
            </button>
            <button
              onClick={handleNext}
              className="absolute -right-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg transition-all duration-200 transform hover:scale-110 hover:from-cyan-600 hover:to-blue-600 hover:shadow-cyan-500/50"
            >
